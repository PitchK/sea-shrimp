...
var allModels = [{modelName: 'Attacker fish', modelURL: 'https:/pitchk.github.io/models/attackerfish.jpg', difficulty: 6.5, tags: ['Living', 'Attacker'], description: '(No description provided)', webLink: '/attacker-fish', time: '12-20 min'}];
